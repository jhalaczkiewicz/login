...
(:
 ...
 :)
declare variable $config:default-template :="poslowie.html";
...
(:~
 ...
 :)
declare variable $config:default-odd :="dantiscus2.odd";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("dantiscus2.odd");
